...
public class ArenaGame {
    ...
    public static void main(String[] args) {
        ...
        characters.add(new Assassin("Zed", 260, 45, 15, 40));

        // Team B (Goblin team)
        characters.add(new Goblin("Goblin 1", 1200, 1500, Faction.TEAM_B));
        characters.add(new Goblin("Goblin 2", 1000, 1000, Faction.TEAM_B));
        characters.add(new Goblin("Goblin 3", 800, 1200, Faction.TEAM_B));
